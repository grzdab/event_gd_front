...
//     }
//
//     const equipmentDataPresent = (
//       currentItem.equipmentData.width +
//       currentItem.equipmentData.length +
//       currentItem.equipmentData.height +
//       currentItem.equipmentData.weight +
//       currentItem.equipmentData.powerRequired +
//       currentItem.equipmentData.staffNeeded +
//       currentItem.equipmentData.minimumAge +
//       currentItem.equipmentData.maxParticipants) > 0 ? true : false;
//
//     const item = {
//       id: currentItem.id,
...
//       equipmentData: {
//         id: equipmentDataPresent ? currentItem.id : 0,
//         equipmentId: currentItem.id,
//         width: currentItem.equipmentData.width,
//         length: currentItem.equipmentData.length,
//         height: currentItem.equipmentData.height,
//         weight: currentItem.equipmentData.weight,
//         powerRequired: currentItem.equipmentData.powerRequired,
//         staffNeeded: currentItem.equipmentData.staffNeeded,
//         minimumAge: currentItem.equipmentData.minimumAge,
//         maxParticipants: currentItem.equipmentData.maxParticipants
//       },
//       category: {
...
//                                   id="length"
//                                   name="length"
//                                   defaultValue={currentItem.equipmentData?.length ? currentItem.equipmentData.length : 0}
//                                   className="form-control"
//                                   onChange={(e) => {
//                                     setCurrentItem({...currentItem,
...
//                                   id="width"
//                                   name="width"
//                                   defaultValue={currentItem.equipmentData?.width ? currentItem.equipmentData.width : 0}
//                                   className="form-control"
//                                   onChange={(e) => {
//                                     setCurrentItem({...currentItem,
...
//                                   id="height"
//                                   name="height"
//                                   defaultValue={currentItem.equipmentData?.height ? currentItem.equipmentData.height : 0}
//                                   className="form-control"
//                                   onChange={(e) => {
//                                     setCurrentItem({...currentItem,
...
//                                   name="area"
//                                   value={
//                                     (currentItem.equipmentData?.length && currentItem.equipmentData?.width) ?
//                                       (currentItem.equipmentData.length * currentItem.equipmentData.width) : 0
//                                   }
//                                   className="form-control"
//                                   readOnly
//                                 />
...
//                                   id="weight"
//                                   name="weight"
//                                   defaultValue={currentItem.equipmentData?.weight ? currentItem.equipmentData.weight : 0}
//                                   className="form-control"
//                                   onChange={(e) => {
//                                     setCurrentItem({...currentItem,
...
//                                   id="powerRequired"
//                                   name="powerRequired"
//                                   defaultValue={currentItem.equipmentData?.powerRequired ? currentItem.equipmentData.powerRequired : 0}
//                                   className="form-control"
//                                   onChange={(e) => {
//                                     setCurrentItem({...currentItem,
...
//                             id="staffNeeded"
//                             name="staffNeeded"
//                             defaultValue={currentItem.equipmentData?.staffNeeded ? currentItem.equipmentData.staffNeeded : 0}
//                             className="form-control"
//                             onChange={(e) => {
//                               setCurrentItem({...currentItem,
...
//                             id="minimumAge"
//                             name="minimumAge"
//                             defaultValue={currentItem.equipmentData?.minimumAge ? currentItem.equipmentData.minimumAge : 0}
//                             className="form-control"
//                             onChange={(e) => {
//                               setCurrentItem({...currentItem,
...
//                             defaultValue={currentItem.equipmentData?.maxParticipants ? currentItem.equipmentData.maxParticipants : 0}
//                             className="form-control"
//                             onChange={(e) => {
//                               setCurrentItem({...currentItem,
