...
const EquipmentCategory = () => {
  ...
  const dataUrl ="/equipment-category";
  const relatedItemsUrl = "/equipment/category"; // if no need to check it, initialize with null and remove RelatedItemsList from details modal
  const defaultItem = equipmentCategoryDefault;
  const itemName = "equipment category";
  const itemNames = "equipment categories";
