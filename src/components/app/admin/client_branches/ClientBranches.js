...
const ClientBranches = () => {
    ...
    const dataUrl ="/admin/businessBranch";
    //od Justyny
    const relatedItemsUrl = "/client/businessBranch"; // if no need to check it, initialize with null and remove RelatedItemsList from details modal
    const defaultItem = clientBranchDefault;
    const itemName = "business branch";
    const itemNames = "business branches";
