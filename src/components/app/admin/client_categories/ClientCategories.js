...
const ClientCategories = () => {
    ...
    const dataUrl ="/admin/businessCategory";
    //od Justyny
    const relatedItemsUrl = "/client/businessCategory"; // if no need to check it, initialize with null and remove RelatedItemsList from details modal
    const defaultItem = clientCategoryDefault;
    const itemName = "business category";
    const itemNames = "business categories";
