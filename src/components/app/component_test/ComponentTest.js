...
// import { selectPostIds, getPostsStatus, getPostsError } from "./redux/reducers/ownershipTypesSlice";
//
// import {
//   onAddDataClick,
//   onSaveAndClose,
...
//
//   const ownershipTypes = useSelector(selectPostIds);
//   const itemsStatus = useSelector(getPostsStatus);
...
//
//     content = ownershipTypes.map(e =>
//       <tr key={e.id}>
//         <td>{e.id}</td>
//         <td>{e.name}</td>
//         <td><button className='btn btn-outline-info'><FontAwesomeIcon icon={faEye}/></button></td>
...
//
//   return (
//     <div id="layoutSidenav_content" style={{backgroundColor: "rgb(200, 200, 200)"}}>
